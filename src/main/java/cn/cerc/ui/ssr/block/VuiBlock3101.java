...
@Description("手机表格行3101")
public class VuiBlock3101 extends VuiBoard implements ISupportBoard {

    public VuiBlock3101() {
        this(null);
    }
    
    public VuiBlock3101(UIComponent owner) {
        super(owner);
    ...
    public VuiBlock3101 ratio(int slot0Ratio, int slot1Ratio, int slot2Ratio) {
