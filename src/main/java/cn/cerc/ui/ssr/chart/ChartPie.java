...
public class ChartPie extends VuiControl implements ICommonSupportChart, ISupportPanel {
    ...
    public void output(HtmlWriter html) {
        ...
        html.println("</div>");
        html.println("<script>$(function(){buildPieChart(`%s`, '%s')})</script>", dataSet.json(), title);
    }
