...
public class SsrFormStyleDefaultTest {
    ...
    public void test1() {
        ...
        assertEquals(
                """
                        ...
                        <label title="查询条件" for="SearchText_" ><em>查询条件</em></label>
    ...
    public void test3() {
        ...
        assertEquals("""
                ...
                <label title="是否可为空" for="null_able_" ><em>是否可为空</em></label>
    ...
    public void test4() {
        ...
        assertEquals(
                """
                        <form method='post' action='' id='form1' role='search'><ul><li >
                        <label title="单据状态" for="status_" ><em>单据状态</em></label>
    ...
    public void test5() {
        ...
        assertEquals(
                """
                        <form method='post' action='' id='form1' role='search'><ul><li >
                        <label title="制单人员" for="code__name"><em>制单人员</em></label>
                        <div>
    ...
    public void test6() {
        ...
        assertEquals(
                """
                        <form method='post' action='' id='form1' role='search'><ul><li >
                        <label title="起始日期" for="start_date_"><em>起始日期</em></label>
                        <div>
    ...
    public void test7() {
        ...
        assertEquals(
                """
                        <form method='post' action='' id='form1' role='search'><ul><li >
                        <label title="起始时间" for="start_time_"><em>起始时间</em></label>
                        <div>
    ...
    public void test8() {
        ...
        assertEquals(
                """
                        <form method='post' action='' id='form1' role='search'><ul><li >
                        <label title="单据日期" for="start_date_"><em>单据日期</em></label>
                        <div class="dateArea">
    ...
    public void test9() {
        ...
        assertEquals("""
                <form method='post' action='' id='form1' role='search'><ul><li >
                <label title="详细地址" for="address_"><em>详细地址</em></label>
                <div>
    ...
    public void test10() {
        ...
        assertEquals(
                """
                        <form method='post' action='' id='form1' role='search'><ul><li >
                        <label title="单据类型" for="type_" ><em>单据类型</em></label>
                        ...
                        <label title="运单类型" for="type2_" ><em>运单类型</em></label>
    ...
    public void test11() {
        ...
        assertEquals(
                """
                        <li >
                        <label title="姓名" for="name" ><em>姓名</em></label>
